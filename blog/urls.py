...
from .views import (
    PostCreateView,
    PostUpdateView, DeleteView, UserEditView,
...
urlpatterns = [
    ...
    path('<int:pk>/edit_profile_page', views.EditProfilePageView.as_view(
        ), name='edit_profile_page'),
    path('create_profile_page', views.CreateProfilePageView.as_view(
